...
<table>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_zarinpal_API_PAYMENT_NAME'); ?></td>
    ...
    ?></td>
        <!--td><?php echo $payment->zarinpal_response_trx_id;
    ?></td -->
    ...
    ?>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_zarinpal_API_ERROR_CODE');
    ?></td>
        <td><?php echo $responseData['L_ERRORCODE0'];
    ?></td>
    </tr>
	<?php 
}
    ...
    ?>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_zarinpal_API_ERROR_DESC');
    ?></td>
        <td><?php echo $responseData['L_LONGMESSAGE0'];
    ?></td>
    </tr>
    <?php 
}
