...
<table>
	...
	<tr>
        ...
        <!--td><?php echo $payment->zarinpal_response_trx_id; ?></td -->
        <td><?php echo $payment->txn_id; ?></td>
    </tr>
    <?php } else { ?>
	    <?php if (isset( $responseData['L_ERRORCODE0']) ) { ?>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_zarinpal_API_ERROR_CODE'); ?></td>
        <td><?php echo $responseData['L_ERRORCODE0']; ?></td>
    </tr>
	<?php } ?>
	<?php if (isset( $responseData['L_LONGMESSAGE0']) ) { ?>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_zarinpal_API_ERROR_DESC'); ?></td>
