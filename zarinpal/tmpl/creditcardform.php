...
vmJsApi::addJScript('/plugins/vmpayment/zarinpal/zarinpal/assets/js/site.js');
        ...
        <table border="0" cellspacing="0" cellpadding="2" width="100%">
            <tr valign="top">
                <td nowrap width="10%" align="right">
                    <label for="creditcardtype"><?php echo vmText::_('VMPAYMENT_zarinpal_CC_CCTYPE'); ?></label>
                </td>
                <td>
            ...
            <tr valign="top">
                <td nowrap width="10%" align="right">
                    <label for="cc_type"><?php echo vmText::_('VMPAYMENT_zarinpal_CC_CCNUM'); ?></label>
                </td>
                <td>
            ...
            <tr valign="top">
                <td nowrap width="10%" align="right">
                    <label for="cc_cvv"><?php echo vmText::_('VMPAYMENT_zarinpal_CC_CVV2') ?></label>
                </td>
                <td>
