...
class zarinpalHelperzarinpal
{
    ...
    public function __construct($method, $zarinpalPlugin)
    {
    ...
    public function getzarinpalPaymentCurrency($getCurrency = false)
    {
    ...
    protected function checkzarinpalIps($zarinpal_data)
    {
        ...
        */
        ...
        if ($this->_method->sandbox) {
            ...
            $zarinpal_iplist3 = ['216.113.188.202', '216.113.188.203', '216.113.188.204', '66.211.170.66'];
...
// http://forum.virtuemart.net/index.php?topic=115375.msg406664#msg406664
            ...
            //------------api-aa.zarinpal.com------------
            $zarinpal_iplist_api_aa = ['173.0.88.67', '173.0.88.99', '173.0.84.99', '173.0.84.67'];
            //'------------api-3t.zarinpal.com------------'
            $zarinpal_iplist_api_3t_aa = ['173.0.88.69', '173.0.88.101', '173.0.84.69', '173.0.84.101'];
            //------------api-aa-3t.zarinpal.com------------
            $zarinpal_iplist_api_aa_3t = ['173.0.88.68', '173.0.88.100', '173.0.84.68', '173.0.84.100'];
            //------------notify.zarinpal.com (IPN delivery)------------
            $zarinpal_iplist_notify = ['173.0.81.1', '173.0.81.33'];
            //'-----------reports.zarinpal.com-----------'
            $zarinpal_iplist_reports = [
                '66.211.168.93',
                '173.0.84.161',
                '173.0.84.198',
                '173.0.88.161',
...
// read the post from zarinpal system and add 'cmd'
        ...
        if (!$fps) {
            ...
            if (!$valid_ipn) {
                if (strstr($res, 'INVALID')) {
                    $errorInfo = ['zarinpal_data' => $zarinpal_data, 'post_msg' => $post_msg, 'zarinpal_res' => $res];
        ...
        */
        ...
        if ($this->_method->zarinpalproduct == 'std') {
            if (strcasecmp($zarinpal_data['business'], $this->merchant_email) != 0) {
                $errorInfo = ['zarinpal_data' => $zarinpal_data, 'merchant_email' => $this->merchant_email];
    ...
    public static function getzarinpalCreditCards()
    {
        return [
            'Visa',
            'Mastercard',
    ...
    public function _is_full_refund($payment, $zarinpal_data)
    {
